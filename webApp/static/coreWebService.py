import os,functools,asyncio,inspect,logging
...
def get(path):
    def decatertor(func):
        ...
        def wrapper(*arg,**kw):
            return func(*arg,**kw)
        wrapper.__methon__='GET'
        wrapper.__methon__= path
        return wrapper
    return decatertor
